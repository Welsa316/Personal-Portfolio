...
<template>
  ...
  >
    ...
    <!-- Content -->
    <div class="p-6">
      <h3 class="font-display text-xl text-ink-950">{{ project.title }}</h3>
      ...
      <div class="mt-5 flex items-center gap-4">
        <a
          ...
          class="inline-flex items-center gap-1.5 text-sm font-medium text-ink-600 transition-colors hover:text-accent-light"
        >
